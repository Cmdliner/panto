...
export default function BestSelling() {
    return (
        <section className="min-h-screen bg-[#f7f7f7] p-8 md:p-16 flex flex-col gap-12">
            <h1 className="text-center text-[42px] font-bold">Best Selling Product</h1>


            <div className="flex justify-between items-center bg-[#eee] min-w-[100%] md:min-w-[27%] p-2 rounded-full m-auto">
            ...
            <div className="flex justify-center md:justify-between items-baseline flex-wrap">
